...
organic.nn.pred1 = as.numeric(unlist(organic.nn.pred1$net.result))
confusionMatrix(organic.nn.pred1,valid.df.nn$TargetBuy)

# Neural Network (Less variables)
org.nn2 <- neuralnet(TargetBuy ~ Salt + Fat, data = cheese.df, linear.output = F, hidden = 3)
```
